...
{
	private $requiredParameters = array('name', 'value', 'category', 'amountt', 'barcode');
	...
	{
		$query =  "INSERT INTO product (name, value, category, amountt, barcode) VALUES ('".$product->getName()."','".
					$product->getValue()."','".
					$product->getCategory()."','".
					$product->getamountt()."','". 
					$product->getBarcode()."')";
