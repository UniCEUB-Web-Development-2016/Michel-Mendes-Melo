...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		$id =  $_GET['id']; 
	?>
      <form class="form-signin" action="updateemployee2.php" method="post">
        <h2 class="form-signin-heading">Please update Employee</h2>
		...
		<input type="number" name="salary"id="inputSalary" class="form-control" placeholder="Salary" required autofocus>
		
		<input type='text' name='id' id='inputId' value="<?php echo $id ?>"/>
		
		<button class="btn btn-lg btn-primary btn-block" type="submit">Update</button>
		<br>
		<a href="employee.html" button type="button" class="btn btn-default">Back</button>
      </form>
