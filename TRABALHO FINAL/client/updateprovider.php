...
<html lang="en">
  ...
  <body>
	...
	<?php
		...
		$id =  $_GET['id']; 
	?>
      <form class="form-signin" action="updateprovider2.php" method="post">
        <h2 class="form-signin-heading">Please update Provider</h2>

        <input type="text" name="name" id="inputName" class="form-control" placeholder="Name" required autofocus>

        <input type="text" name="tradename"id="inputTradeName" class="form-control" placeholder="Trade Name" required autofocus>
		...
		<input type="number" name="cep"id="inputCep" class="form-control" placeholder="CEP" required autofocus>
		
		<input type="text" name="city"id="inputCity" class="form-control" placeholder="City" required autofocus>

        <input type="number" name="cnpj"id="inputCnpj" class="form-control" placeholder="CNPJ" required autofocus>

		<input type='text' name='id' id='inputId' value="<?php echo $id ?>"/>
		
		<button class="btn btn-lg btn-primary btn-block" type="submit">Update</button>
		<br>
		 <a href="provider.html" button type="button" class="btn btn-default">Back</button>
      </form>
